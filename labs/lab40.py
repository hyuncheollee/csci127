...
#This program will do something with images
...
def main():
     ...
     for i in range(8):
          ...
          mpl.imshow(img2)    #Load our new image into pyplot
          mpl.show()          #Show the image (waits until closed to continue)

     #Shows the original image:
     mpl.imshow(img)	      #Load image into pyplot
     mpl.show()               #Show the image (waits until closed to continue)
